...
echo "Build of the Dell Cloud Manager Security Guide is finished. The HTML pages are in ${BUILDDIR}/html."
...
git clone git@github.com:gforghetti/dcm_security_guide.git ${GHPAGESDIR}
if [ $? -ne 0 ]
then
  printf "git clone git@github.com:gforghetti/dcm_security_guide.git failed!\n" >&2
  exit 1
fi
