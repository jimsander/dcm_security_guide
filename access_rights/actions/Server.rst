.. raw:: html
  ...
  <tr>
    ...
    <td width="*" class="jdsl">Add port forwarding rules for server</td>
  </tr>
  <tr>
    <td width="25%" class="jdsr">  Configure </td>
    <td width="*" class="jdsl">Edit Server</br><ul><li>product<li>server-name<li>users - (DCM Agent Must be operational)</ul></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="*" class="jdsl">Add/Remove DCM Users to `Server`</br>(DCM Agent Must be operational)</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="*" class="jdsl">Remove port forwarding rules for server</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="*" class="jdsl">View DCM Agent Logs </br>(DCM Agent Must be operational)</td>
  </tr>
  <tr>
    <td width="25%" class="jdsr">  ViewPassword </td>
    <td width="*" class="jdsl">View the Server admin logon credentials</td>
  </tr>
  </table>
  <!-- END OF Server.rst -->
