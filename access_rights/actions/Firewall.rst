.. raw:: html
  ...
  <tr>
    <th width="25%" class="jdsr" rowspan="9"">Firewall</th>
  </tr>

  <tr>
    <td width="25%" class="jdsr">  Access </td>
    <td width="*" class="jdsl">Allow management of Firewalls</td>
  </tr>
  <tr>
    <td width="25%" class="jdsr">  Add Rule </td>
    <td width="*" class="jdsl">Add a Firewall rule</td>
  </tr>
  <tr>
    <td width="25%" class="jdsr">  Copy </td>
    <td width="*" class="jdsl">Duplicate a Firewall from an existing Firewall</td>
  </tr>
  <tr>
    <td width="25%" class="jdsr">  Configure </td>
    <td width="*" class="jdsl">Edit Firewall metadata</br><ul><li>name<li>description</ul> </td>
  </tr>
  <tr>
    <td width="25%" class="jdsr">  Create </td>
    <td width="*" class="jdsl">Create new Firewall</td>
  </tr>
  <tr>
    <td width="25%" class="jdsr">  Delete </td>
    <td width="*" class="jdsl">Delete Firewall</td>
  </tr>
  <tr>
    <td width="25%" class="jdsr">  Remove Rule </td>
    <td width="*" class="jdsl">Remove a Firewall rule</td>
  </tr>
  <tr>
    <td width="25%" class="jdsr">  View Logs </td>
    <td width="*" class="jdsl">***Deprecated****</td>
  </tr>
  </table>
  <!-- END OF Firewall.rst -->
