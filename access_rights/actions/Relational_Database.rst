.. raw:: html
  ...
  <tr>
    ...
    <td width="*" class="jdsl">Edit Relational Database metadata  </br><ul><li>name<li>description</ul></td>
  </tr>
  <tr>
    <td width="25%" class="jdsr">  Create </td>
    <td width="*" class="jdsl">Create a `Relation DB Management System` </br><div class="jdsf">**Qualifer Indistinct***</div></td>
  </tr>
  <tr>
    <td width="25%" class="jdsr">  Terminate </td>
    <td width="*" class="jdsl">Stop and Delete the Relational Database object</td>
  </tr>
  <tr>
