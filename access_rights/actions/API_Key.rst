.. raw:: html
  ...
  <tr>
    ...
    <td width="*" class="jdsl">Allow Access to the User API Keys (View/Enable )</td>
  </tr>
  <tr>
    <td width="25%" class="jdsr">  Create User Key </td>
    <td width="*" class="jdsl">Allow User to create or edit a User Key</br> <div class="jdsf">Qualifer Indistinct</div></td>
  </tr>
  </table>
  <!-- END OF API_Key.rst -->

.. note:: [API_Key] A user will never be allowed to see any user key than their own.
