.. raw:: html
  ...
  <tr>
    ...
    <td width="*" class="jdsl">Edit IP metadata </br><ul><li>name<li>description</ul></td>
  </tr>
  <tr>
    <td width="25%" class="jdsr">  Create </td>
    <td width="*" class="jdsl">Create an IP to be attached/assigned </br><div class="jdsf">**Qualifer Indistinct***</div></td>
  </tr>
  <tr>
